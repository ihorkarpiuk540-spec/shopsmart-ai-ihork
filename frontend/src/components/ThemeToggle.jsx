...
function ThemeToggle() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      {/* Tooltip */}
      {showTooltip && (
        <div className="absolute bottom-20 right-0 px-4 py-2 bg-gray-900 dark:bg-gray-800 text-white text-sm font-medium rounded-lg shadow-xl whitespace-nowrap z-50">
          AI Helper - Change Mode
      ...
      <motion.button
        ...
        className="p-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl shadow-xl shadow-blue-500/30 hover:shadow-blue-500/50 transition-all"
      >
